# ClapMe [![Build Status](https://travis-ci.org/droundy/clapme.svg?branch=master)](https://travis-ci.org/droundy/clapme) [![](https://docs.rs/clapme/badge.svg)](https://docs.rs/clapme)
